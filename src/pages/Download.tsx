    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 mt-16">
        ...
        >
          ...
          <Badge
            variant="secondary"
            className="mb-8 bg-red-100 text-red-600 hover:bg-red-200"
          >
            모두의 리마인더
          </Badge>
        </motion.div>
              ...
              <div className="mt-6 pt-4 border-t border-gray-200">
                ...
                <div className="text-xs text-gray-500 space-y-1">
                  {selectedPlatform === 'Windows' && (
                    <>
                      <p>
                        • 최소 사양: Windows 10 이상, 2GB RAM, 150MB 디스크 공간
                      </p>
                      <p>
                        • 설치 파일은 디지털 서명이 되어 있으며 바이러스 검사를
                        완료했습니다.
                      </p>
                      <p>
                        • 설치 중 문제가 발생하면{' '}
                        <span className="text-[#61C9A8]">
                          support@amnesia.kr
                        </span>
                        로 문의해 주세요.
                      </p>
                  ...
                  {selectedPlatform === 'Chrome Browser Extension' && (
                    <>
                      <p>
                        • Chrome, Edge, Brave 등 Chromium 기반 브라우저 지원
                      </p>
