...
const MOCK_NOTES_METADATA = [
  { id: "1", title: "첫 번째 노트" },
  { id: "2", title: "두 번째 노트" },
  { id: "3", title: "세 번째 노트" }
];
const MOCK_NOTE_CONTENTS = {
...
const fetchNoteContent = (noteId) => {
  console.log(`📞 API 요청: 노트 ID [${noteId}]의 내용 가져오는 중...`);
  return new Promise((resolve) => setTimeout(() => resolve(MOCK_NOTE_CONTENTS[noteId]), 500));
};
const NoteList = reactExports.memo(({ notes, selectedNoteId, onSelectNote }) => {
  console.log("%c🎨 NoteList 컴포넌트 리렌더링!", "color: orange;");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { border: "1px solid #ccc", padding: "10px", width: "300px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "노트 목록" }),
    notes.map((note) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
...
function App() {
  ...
  const [detailedNote, setDetailedNote] = reactExports.useState(null);
  const [isListLoading, setIsListLoading] = reactExports.useState(true);
  const [isContentLoading, setIsContentLoading] = reactExports.useState(false);
  ...
  const handleSelectNote = reactExports.useCallback((noteId) => {
    setSelectedNoteId(noteId);
  }, []);
  if (isListLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "전체 노트를 불러오는 중..." });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "20px", padding: "20px" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { border: "1px solid #ccc", padding: "10px", flex: 1 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "상세 내용" }),
      isContentLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "노트 내용을 불러오는 중..." }) : detailedNote ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: detailedNote.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: detailedNote.content })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "노트를 선택해주세요." })
    ] })
  ] });
}
async function initializePlatform(platformName) {
  try {
    const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./platforms/extension/index.tsx": () => __vitePreload(() => import("./extension-C-ZLOKJt.js"), true ? [] : void 0), "./platforms/web/index.tsx": () => __vitePreload(() => import("./web-ABlYIY5Y.js"), true ? [] : void 0), "./platforms/webapp/index.tsx": () => __vitePreload(() => import("./webapp-BAav2Rp3.js"), true ? [] : void 0) }), `./platforms/${platformName}/index.tsx`, 4);
