...
import { Copy, Key, AlertCircle, Loader2, Users, Search as SearchIcon } from "lucide-react";
...
export const Login: React.FC = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-gradient-to-br from-white to-[#e6f7f2]">
      ...
      <div className="w-full lg:w-1/2 pl-16 flex items-center justify-center lg:justify-start p-8 order-first lg:order-last bg-gradient-to-b lg:bg-gradient-to-r from-white to-[#e6f7f2]">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mt-6">
            ...
            <p className="text-gray-600 mt-2 max-w-sm mx-auto flex flex-row items-center">
              Amnesia는 생각과 아이디어를 항상 안전하게 보관합니다.<br/>언제 어디서나 접근하세요.
            </p>
          </div>
        </div>
      </div>
